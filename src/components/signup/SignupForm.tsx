  ...
  return (
    <MemberDetailWrap>
      ...
      <MemberJoinTop>
        ...
        <TxtHint>
          <TxtHintP>
            신규 가입 통합 마일리지는 1인 1회 지급으로 오프라인 가입 이력이 있으신 경우, 마일리지가 지급되지 않습니다.
          </TxtHintP>
        </TxtHint>
      </MemberJoinTop>
      {/* F&F 통합회원 특별혜택 end */}
        ...
        <section className="sect receive" style={{ display: 'block' }}>
          <Togbox id="termToggle">
            <Hbox>
              ...
              <small id="chkReciveError" style={{ display: 'none', color: 'red', fontSize: '13px' }}>
                필수약관에 동의를 체크해 주세요.
              </small>
              ...
              <ul className="list">
                  ...
                  <AgreeWrap>
                    <AgreeWrapItems>
                      <BoxItems>
                        <Item>
                          <CheckSkin>
                            <input type="checkbox" name="onlineSiteUsefStplat" id="onlineSiteUsefStplat" value="Y" />
                            <span>선택</span>
                          </CheckSkin>
                    ...
                    <AgreeItems>
                      <BoxItems>
                        <Item>
                          <CheckSkin>
                            <input type="checkbox" name="psnlInfoColctUsefAgr" id="psnlInfoColctUsefAgr" value="Y" />
                            <span>선택</span>
                          </CheckSkin>
                    ...
                    <AgreeItems>
                      <BoxItems>
                        <Item>
                          <CheckSkin>
                            <input type="checkbox" name="psnlInfoUseAgr" id="psnlInfoUseAgr" value="Y" />
                            <span>선택</span>
                          </CheckSkin>
                ...
                <TogboxList>
                  ...
                  <BoxItems>
                    <Item>
                      <CheckSkin>
                        <input type="checkbox" name="emailRecptnAgrYn" id="emailRecptnAgrYn" value="Y" />
                        <span>선택</span>
                      </CheckSkin>
                    ...
                    <Item>
                      <CheckSkin>
                        <input type="checkbox" name="smsRecptnAgrYn" id="smsRecptnAgrYn" value="Y" />
                        <span>선택</span>
                      </CheckSkin>
